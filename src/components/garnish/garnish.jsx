...
import { GarnishData } from "../constants/garnish";

const garnish = GarnishData();

const Garnish = (props) => {
  const [counts, setCounts] = useState(new Array(garnish.length).fill(0));
  ...
  const handleDecrement = (foodIndex) => {
    setCounts((prevCounts) => {
      ...
      onRemoveItem(garnish[foodIndex]);
      return newCounts;
    });
  };
