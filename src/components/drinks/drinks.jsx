...
import { DrinkData } from "../constants/drinks";

const drinks = DrinkData();

const Drinks = (props) => {
  const [counts, setCounts] = useState(new Array(drinks.length).fill(0));
