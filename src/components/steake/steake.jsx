...
import { SteakeData } from "../constants/steake";

const steakes = SteakeData();

const Steakes = (props) => {
  const [counts, setCounts] = useState(new Array(steakes.length).fill(0));
  ...
  const handleDecrement = (foodIndex) => {
    setCounts((prevCounts) => {
      ...
      onRemoveItem(steakes[foodIndex]);
      return newCounts;
    });
  };
