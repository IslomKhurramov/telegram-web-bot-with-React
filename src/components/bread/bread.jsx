...
import { BreadData } from "../constants/bread";

const breads = BreadData();

const Bread = (props) => {
  const [counts, setCounts] = useState(new Array(breads.length).fill(0));
