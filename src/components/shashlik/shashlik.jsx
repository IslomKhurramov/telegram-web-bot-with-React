...
import { Shashlik } from "../constants/shashlik";

const shashlik = Shashlik();

const ShashlikPage = (props) => {
  const [counts, setCounts] = useState(new Array(shashlik.length).fill(0));
  ...
  const handleDecrement = (foodIndex) => {
    setCounts((prevCounts) => {
      ...
      onRemoveItem(shashlik[foodIndex]);
      return newCounts;
    });
  };
