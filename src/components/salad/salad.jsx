...
import { SaladsData } from "../constants/salads";

const salad = SaladsData();

const Salads = (props) => {
  const [counts, setCounts] = useState(new Array(salad.length).fill(0));
